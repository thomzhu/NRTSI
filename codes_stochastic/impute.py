...
loss, avg_loss, gt_change_of_step_size, imp_change_of_step_size, gt_path_len, path_len = run_imputation(model, test_data.repeat(20,1,1), args.num_missing, ckpt_dict, confidence=params.confidence , max_level=params.max_level, fig_path = os.path.join(params.exp_dir, 'impute'), 
